...
export default function SettingsTab() {
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      {/* Legacy Migration Info Banner */}
      <div className="bg-purple-500/5 border border-purple-500/10 rounded-xl p-4">
        <div className="flex items-start gap-2">
          <Info className="w-4 h-4 text-purple-400 flex-shrink-0 mt-0.5" />
          <div>
            <p className="text-xs text-purple-400 font-medium">Legacy Backup Support</p>
            <p className="text-xs text-[#666] mt-1">
              Older backups with &quot;Incomplete&quot; status are automatically migrated to &quot;Complete&quot;
              during import. Dropped entries are automatically excluded from Favorites and Top 10.
            </p>
          </div>
        </div>
      </div>
